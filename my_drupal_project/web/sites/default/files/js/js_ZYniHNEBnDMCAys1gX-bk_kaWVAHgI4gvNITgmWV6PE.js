...
(function ($, Drupal) {
  ...
  Drupal.behaviors.usuariosDiegoPager = {
    ...
    attach: function (context, settings) {
      ...
      $('.pager__item a, .pager a, .pager-item a, .pager li a, ul.pager li a, .pager-manual a', context).each(function() {
      ...
      $('.pager__item a, .pager a, .pager-item a, .pager li a, ul.pager li a, .pager-manual a', context).once('ajax-pager').on('click', function (e) {
        e.preventDefault();
        ...
        if (!originalUrl || originalUrl === '#') {
          ...
          if (classes) {
            ...
            if (classes.indexOf('pager__item--next') >= 0 || 
              ...
              var activePage = $('.pager__item.is-active a, .pager-current, .active a', context).first().text();
