...
/**
 * @file
 * JavaScript para manejar la paginación y búsqueda con AJAX.
 */
(function ($, Drupal) {
  'use strict';
  ...
  Drupal.behaviors.usuariosDiegoPager = {
    attach: function (context, settings) {
      ...
      $('.pager__item a', context).once('ajax-pager').on('click', function (e) {
        ...
        if (searchName) {
          requestParams.search_name = searchName;
        }
        if (searchSurname) {
          requestParams.search_surname = searchSurname;
        }
        if (searchEmail) {
          requestParams.search_email = searchEmail;
        }
        
        // Realizar la solicitud AJAX
        $.ajax({
          url: Drupal.url('usuarios-list'),
          type: 'GET',
          data: requestParams,
