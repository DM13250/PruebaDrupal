...
(function ($, Drupal) {
  ...
  Drupal.behaviors.usuariosDiegoPager = {
    ...
    attach: function (context, settings) {
      // Cuando hacemos clic en los enlaces del paginador
      $('.pager__item a', context).once('ajax-pager').on('click', function (e) {
        // Evitamos que el enlace funcione normalmente
        e.preventDefault();
        
        // IMPORTANTE: Usamos el href original del enlace
        // Esto garantiza que tenemos la ruta correcta
        var originalUrl = $(this).attr('href');
        
        // Extraemos el número de página del enlace
        ...
        // SOLUCIÓN: Usamos drupalSettings.path.baseUrl para obtener la URL base correcta
        var baseUrl = drupalSettings.path.baseUrl + 'usuarios-list';
        console.log('URL base de Drupal:', drupalSettings.path.baseUrl);
        console.log('URL completa para AJAX:', baseUrl);
        
        // Realizamos la petición AJAX con la URL base correcta
        $.ajax({
          url: baseUrl,
          type: 'GET',
          data: params,
